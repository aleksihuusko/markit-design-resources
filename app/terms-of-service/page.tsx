          ...
          <div className="mx-auto w-full max-w-lg">
            <div className="prose prose-stone dark:prose-invert">
              <>
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      ...
                      Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                      &quot;Our&quot; in this Agreement) refers to Markit.
                    </p>
                  </li>
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to Markit Website,
                      accessible from{" "}
                      <a
                        href="https://www.markit.design"
                        rel="external nofollow noopener"
                        target="_blank"
                      >
                        https://www.markit.design
                      </a>
                    </p>
                  </li>
                  <li>
                ...
                <ul>
                  <li>By email: contact@markit.design</li>
                </ul>
              </>
            </div>
          </div>
