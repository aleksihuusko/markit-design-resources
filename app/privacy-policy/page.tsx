        ...
        <div className="container">
          <div className="mx-auto w-full max-w-lg text-center">
            ...
            <p className="text-balance text-muted-foreground md:text-lg">
              {`Markit operates the markit.design website, which provides the service.`}
            </p>
          </div>
        </div>
      </header>
            ...
            <div className="prose prose-stone dark:prose-invert">
              <>
                <p>
                  ...
                  Information if anyone decided to use our Service, the Markit
                  Website website.
                </p>
                ...
                <p>
                  ...
                  markit.design, unless otherwise defined in this Privacy
                  Policy.
                </p>
